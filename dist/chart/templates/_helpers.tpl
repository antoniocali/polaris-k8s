...
*/}}
{{- define "polaris-k8s.namespaceName" -}}
{{- .Release.Namespace }}
{{- end }}
...
*/}}
{{- define "polaris-k8s.resourceName" -}}
{{- $fullname := include "polaris-k8s.fullname" .context }}
{{- $suffix := .suffix }}
...
*/}}
{{- define "polaris-k8s.serviceAccountName" -}}
{{- if and (not (.Values.serviceAccount.enable | default true)) .Values.serviceAccount.name }}
{{- .Values.serviceAccount.name }}
{{- else }}
{{- include "polaris-k8s.resourceName" (dict "suffix" "controller-manager" "context" .) }}
{{- end }}
{{- end }}
